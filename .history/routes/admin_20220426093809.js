...
//Setting up how files should be stored in the uploads folder
// const storage = multer.diskStorage({
//   destination: function (req, file, cb) {
//     cb(null, "./public/images/driversPhoto/");
//   },
...
router.get("/request-single/:id", async (req, res) => {
  ...
  const request = await dbObject.GetSingleDepartmentRequestByRequestID(id);
...
router.get("/report", async (req, res) => {
  if (Object.keys(req.query).length) {
    ...
    let result = await dbObject.getRequestByDate(
      filterStartDate,
      filterEndDate
    );
