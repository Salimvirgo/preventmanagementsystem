...
dbObject.addNewRequest = (request) => {
  ...
  const sql =
    "INSERT INTO prrequests (userId,deptId, eventDate,eventTitle,eventType,eventvenue,numberOfPrintPersonnel,numberOfRadioPersonnel,numberOfTvPersonnel,funding,mediaType,eventBudget) VALUES (?,?,?,?,?,?,?,?,?,?,?,?);";
...
dbObject.getAllRequests = () => {
  const sql =
    "SELECT requestId, fullname,deptname,eventDate,eventTitle,eventType,eventvenue,numberOfPrintPersonnel,numberOfRadioPersonnel,numberOfTvPersonnel,mediaType,funding,eventBudget,requestStatus,isHODApproved from prrequests inner join users ON prrequests.userId = users.userId inner join departments ON users.department = departments.deptId where isHODApproved = 'Yes' order by requestDate asc;";
...
dbObject.getRequestById = (id) => {
  const sql =
    "SELECT requestId, fullname,deptname, eventDate,eventTitle,eventType,eventvenue,numberOfPrintPersonnel,numberOfRadioPersonnel,numberOfTvPersonnel,mediaType,funding,eventBudget,requestStatus,isHODApproved from prrequests inner join users ON prrequests.userId = users.userId inner join departments ON users.department = departments.deptId where requestId = ?";
...
dbObject.getNewRequests = () => {
  const sql =
    "SELECT fullname,deptname, requestDate,eventDate,eventTitle,eventType,eventvenue,numberOfPrintPersonnel,numberOfRadioPersonnel,numberOfTvPersonnel,mediaType,funding,eventBudget,requestStatus, isHODApproved from prrequests inner join users ON prrequests.userId = users.userId inner join departments ON users.department = departments.deptId where date(requestDate) between date(date_sub(curdate(), interval 3 day)) and curdate() and isHODApproved = 'NO';";
...
dbObject.getAllDepartmentalRequests = (department) => {
  const sql =
    "SELECT requestId, fullname,deptname,eventDate,eventTitle,eventType,eventvenue,numberOfPrintPersonnel,numberOfRadioPersonnel,numberOfTvPersonnel,mediaType,funding,eventBudget,requestStatus,isHODApproved from prrequests inner join users ON prrequests.userId = users.userId inner join departments ON users.department = departments.deptId where department = ? order by requestDate asc;";
...
dbObject.GetNewRequestsByDept = (department) => {
  const sql =
    "SELECT requestId, fullname,deptname, requestDate,eventDate,eventTitle,eventType,eventvenue,numberOfPrintPersonnel,numberOfRadioPersonnel,numberOfTvPersonnel,mediaType,funding,eventBudget,requestStatus, isHODApproved from prrequests inner join users ON prrequests.userId = users.userId inner join departments ON prrequests.deptId = departments.deptId where department = ?;";
  return new Promise((resolve, reject) => {
    connectionPool.query(sql, [department], (err, result) => {
      if (err) return reject(err);
